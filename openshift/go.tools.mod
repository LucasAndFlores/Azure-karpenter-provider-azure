...
// Usage: go get -tool -modfile=go.tools.mod <toolname>

go 1.26.3

// Tools with compatible transitive deps are installed via `go install tool`.
// aks-node-viewer, go-swagger, and ko have conflicting transitive deps
// and are installed separately in openshift-toolchain.sh.
tool (
...
require (
	...
	github.com/Azure/karpenter-provider-azure v0.0.0-00010101000000-000000000000
	github.com/Azure/skewer v0.0.27
...
replace github.com/Azure/karpenter-provider-azure => ./
